...
class HeroData(enum.Enum):
    ...
    """
    alagos = Hero(nam="Alagos", spr=PATH+"01s_Alagos.png", fac=PATH+"01f_Alagos.png",
    ...
    luana = Hero(nam="Luana", spr=PATH+"02s_Luana.png", fac=PATH+"01f_Luana.png",
    ...
    rydalin = Hero(nam="Rydalin", spr=PATH+"04s_Rydalin.png", fac=PATH+"04f_Rydalin.png",
