...
class HeroData(enum.Enum):
    ...
    alagos = dict(nam="Alagos", spr=PATH+"01s_Alagos.png", fac=PATH+"01f_Alagos.png",
                  ...
                  wpn=equipment.weapon.WeaponsData.bronzeshortsword, sld=equipment.shield.ShieldsData.woodenbuckler,
                  arm=equipment.armor.ArmorsData.lightleatherarmor)
    luana = dict(nam="Luana", spr=PATH+"02s_Luana.png", fac=PATH+"02f_Luana.png",
                 ...
                 wpn=equipment.weapon.WeaponsData.bronzedagger, sld=None,
                 arm=equipment.armor.ArmorsData.lightleatherarmor)
    grindan = dict(nam="Grindan", spr=PATH+"03s_Grindan.png", fac=PATH+"03f_Grindan.png",
                   ...
                   wpn=equipment.weapon.WeaponsData.ironlongsword, sld=equipment.shield.ShieldsData.irontarge,
                   arm=equipment.armor.ArmorsData.mediumbronzearmor)
    rydalin = dict(nam="Rydalin", spr=PATH+"04s_Rydalin.png", fac=PATH+"04f_Rydalin.png",
                   ...
                   wpn=equipment.weapon.WeaponsData.bronzestaff, sld=None,
                   arm=equipment.armor.ArmorsData.mediumleatherarmor)
    ...
    galen = dict(nam="Galen", spr=PATH+"06s_Galen.png", fac=PATH+"06f_Galen.png",
                 ...
                 wpn=equipment.weapon.WeaponsData.ironaxe, sld=equipment.shield.ShieldsData.irontarge,
                 arm=equipment.armor.ArmorsData.mediumbronzearmor)
