...
class Alchemist(Skill):
    ...
    def __init__(self, quantity):
        super().__init__(SkillType.alc.value, SkillType.alc.name, 1200, quantity)
...
class Diplomat(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.dip.value, SkillType.dip.name, 400, quantity)
...
class Healer(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.hlr.value, SkillType.hlr.name, 800, quantity)
...
class Loremaster(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.lor.value, SkillType.lor.name, 600, quantity)
...
class Mechanic(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.mec.value, SkillType.mec.name, 400, quantity)
...
class Merchant(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.mer.value, SkillType.mer.name, 600, quantity)
...
class Ranger(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.ran.value, SkillType.ran.name, 800, quantity)
...
class Stealth(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.stl.value, SkillType.stl.name, 400, quantity)
...
class Thief(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.thf.value, SkillType.thf.name, 800, quantity)
...
class Troubadour(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.trb.value, SkillType.trb.name, 800, quantity)
...
class Warrior(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.war.value, SkillType.war.name, 800, quantity)
...
class Wizard(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.wiz.value, SkillType.wiz.name, 1200, quantity)
...
class Hafted(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.haf.value, SkillType.haf.name, 320, quantity)
...
class Missile(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.mis.value, SkillType.mis.name, 480, quantity)
...
class Pole(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.pol.value, SkillType.pol.name, 320, quantity)
...
class Shield(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.shd.value, SkillType.shd.name, 400, quantity)
...
class Sword(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.swd.value, SkillType.swd.name, 480, quantity)
...
class Thrown(Skill):
    ...
    """
    def __init__(self, quantity):
        super().__init__(SkillType.thr.value, SkillType.thr.name, 320, quantity)
