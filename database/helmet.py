...
class HelmetDatabase(enum.Enum):
    ...
    helmofcharisma = dict(nam="Helm of Charisma",   srt=15, val=7,  shp=False, wht=2, prt=1, dip=1, col=64,  row=32)
    helmofinsight = dict(nam="Helm of Insight",     srt=16, val=7,  shp=False, wht=2, prt=1, lor=1, col=96,  row=32)
    helmoftempests = dict(nam="Helm of Tempests",   srt=17, val=7,  shp=False, wht=2, prt=1, war=1, col=128, row=32)
