...
class AccessoryDatabase(enum.Enum):
    ...
    spellbook = dict(nam="Spellbook",           srt=7, val=80, shp=True,  wht=1, min_wiz=9,         col=32,  row=32)
    wizardswand = dict(nam="Wizard's Wand",     srt=8, val=80, shp=True,  wht=1, min_int=26, wiz=2, col=64,  row=32)
