...
class QuestDatabase(enum.Enum):
    ...
    quest1 = dict(qtype=QuestType.FetchItemQuest,
                  ...
                  text=([["Hi mister."],
                         ["I need 5 herbs for my mommy. She's ill."],
    ...
    quest2 = dict(qtype=QuestType.PersonMessageQuest,
                  ...
                  people=dict(person74='main',
                              person75='sub1'),
                  text=dict(person74=([["How are you?"],
    ...
    quest4 = dict(qtype=QuestType.ReceiveItemQuest,
                  ...
                  text=([["It's so beautiful, I can watch this scenery for hours."],
                         ["    .   .   .   .   .   .   .   .   .   .   .   .   ."],
                         ["By the way, have you been bothered",
                          "by that half ass soldier at our town?",
                          "He has taken it up on himself to prevent",
                          "monsters for entering the town!"],
                         ["That may be noble, but he is not able",
                          "to see the difference between a normal",
                          "person and an evil monster."],
                         ["So he asks for proof?!?"],
                         ["I'll give you a 'Proof of not being a monster',",
                          "because you seem a normal person to me.",
                          "*sigh*"]],
                        [[" "]],
                        [[" "]],
                        [[" "]],
