...
class OwnBox(object):
    ...
    Deze class is bijna een exacte kopie van sellbox uit shop.
    """
    ...
    def _setup_table_view(self):
        ...
        for index, row in enumerate(self.table_data):
            ...
            self.table_view[index].append(pygame.image.load(row[0]).subsurface(row[5], row[6], 32, 32).convert_alpha())
